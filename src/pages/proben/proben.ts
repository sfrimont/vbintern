...
export class ProbenPage {
    ...
    stimmen(terminID,anwesend, namen, sopran,sopran2,alt,alt2,tenor1,tenor2,bariton,bass) {
        console.log("hallo");

        let modal = this.modalCtrl.create(AnwesenheitProbePage, {id: terminID,anwesend:anwesend, namen:namen, sopran: sopran, sopran2: sopran2, alt:alt, alt2:alt2, tenor1:tenor1, tenor2:tenor2, bariton:bariton, bass:bass});
        modal.present({
